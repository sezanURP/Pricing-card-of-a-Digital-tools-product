...
const handleRemoveItem = (id) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-10 w-[80%] mx-auto">
            ...
            {cartItems.map((item) => (
              <li className="my-4 rounded-2xl bg-gray-100" key={item.id}>
                <div className="flex items-center gap-6 my-2">
                  ...
                  <button onClick={() => handleRemoveItem(item.id)} className="btn text-red-500 hover:bg-red-200  font-medium py-1 px-3 rounded-lg ml-auto">
                    Remove
                  </button>
                </div>
              </li>
      ...
      <div onClick={handleRemoveFromCart } className="btn bg-blue-500 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-lg flex justify-center items-center mx-auto ">
        Proceed to Checkout
      </div>
    </div>
    </>
